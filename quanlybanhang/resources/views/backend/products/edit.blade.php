...
<form name="frmEditProduct" id="frmEditProduct" method="post" action="{{ route('backend.product.update', ['id' => $product->id]) }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="product_name" name="product_name" aria-describedby="product_nameHelp" placeholder="Nhập Tên sản phẩm" value="{{ old('product_name', $product->product_name) }}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="description" name="description" aria-describedby="descriptionHelp" placeholder="Nhập diễn giải sản phẩm" value="{{ old('description', $product->description) }}">

  </div>
  <div class="form-group">
    <label for="standard_code">Giá nhập sản phẩm</label>
    <input type="text" class="form-control" id="standard_code" name="standard_code" aria-describedby="standard_codeHelp" placeholder="Nhập Giá nhập sản phẩm" value="{{ old('standard_code', $product->standard_code) }}">
  </div>
  <div class="form-group">
    <label for="list_price">Giá bán sản phẩm</label>
    <input type="text" class="form-control" id="list_price" name="list_price" aria-describedby="list_priceHelp" placeholder="Nhập Giá bán sản phẩm" value="{{ old('list_price', $product->list_price) }}">
  </div>
  <div class="form-group">
    <label for="quantily_per_unit">Số lượng sản phẩm</label>
    <input type="text" class="form-control" id="quantily_per_unit" name="quantily_per_unit" aria-describedby="quantily_per_unitHelp" placeholder="Nhập Số lượng sản phẩm" value="{{ old('quantily_per_unit', $product->quantily_per_unit) }}">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="discount" name="discount" aria-describedby="discountHelp" placeholder="Nhập % giảm giá sản phẩm" value="{{ old('discount', $product->discount) }}">
  </div>
  <div class="form-group">
  ...
  <a href="{{ route('backend.product.index') }}" class="btn">Quay về</a>
