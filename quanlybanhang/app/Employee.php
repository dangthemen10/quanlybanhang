...
AuthenticatableContract
{
    ...
    protected $fillable     = ['username', 'last_name', 'first_name', 'email', 'avatar', 'password', 'job_title', 'department', 'manager_id', 'phone', 'address1', 'address2', 'city', 'state', 'postal_code', 'country', 'remember_token','active_code'];
