...
class CategoryCreateRequest extends FormRequest
{
    ...
    {
        return [
            'category_code' => 'required|min:6|max:20|unique:categories', //tên table categories
            'category_name' => 'required|min:6|max:20',
        ];
    }
    public function messages()
    {
        return [
            ...
            'category_code.min' => 'Vui lòng nhập Mã Loại sản phẩm ít nhất 6 ký tự',
            ...
            'category_name.min' => 'Vui lòng nhập Tên sản phẩm ít nhất 6 ký tự',
